...
export const NavigationBar: React.FC<NavigationBarProps> = ({ isScrolled }) => {
  ...
  const navItems = [
    { name: "Solutions", tooltip: "Explore our treasury solutions" },
    { name: "Case Studies", tooltip: "See how customers succeed with us" },
    { name: "Resources", tooltip: "Access guides, webinars, and documentation" },
    { name: "About Us", tooltip: "Learn about our company and mission" }
  ];
